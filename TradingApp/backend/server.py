...
def run_bot(user_id, password, xtb_pair, yahoo_pair, chart_interval):
    ...
    if chart_interval == '30m':
        bot = TradingBotForThirtyMinuteChart(user_id, password, xtb_pair, yahoo_pair, chart_interval, "4d", 30, 0.02)
    elif chart_interval == '1d':
        bot = TradingBotForDailyChart(user_id, password, xtb_pair, yahoo_pair, chart_interval, "30d", 1440, 0.02)
